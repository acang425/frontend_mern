    ...
    <div className="Video">
      <ConfigProvider locale={zhCN}>
        <div className='phone' style={{ background: '#8BAEAE' }}>
          ...
          <div style={{ background: '#0C5757', textAlign: 'center', height: '40px', margin: '20px', padding: '10px', borderRadius: '20px', width: '50%' }}>
            <span style={{ color: 'white', fontSize: '20px', fontWeight: 'bold' }}>Scenario Simulation</span>
          </div>
